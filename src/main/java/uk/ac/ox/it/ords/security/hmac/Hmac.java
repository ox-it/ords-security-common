...
public class Hmac {
	 ...
	 */
	public static boolean isValidSignedRequest(HttpServletRequest request, Map<String, String> consumers){
		...
		//
		String key = getPublicKey(request);
		...
		//
		if ( !consumers.containsKey(key)) return false;

		//
		// Get the secret for this key
		//
		String secret = consumers.get(key);
