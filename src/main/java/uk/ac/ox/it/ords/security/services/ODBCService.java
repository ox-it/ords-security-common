...
public interface ODBCService {
	...
	public abstract void removeRole(String role, String server, String database) throws Exception;
	
	public abstract List<String> getAllODBCRolesForDatabase(String databaseServer,
